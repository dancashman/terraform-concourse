...
data "template_file" "concourse_web_task_template" {
  ...
  vars {
    ...
    concourse_db_uri           = "postgres://${var.concourse_db_username}:${data.aws_kms_secret.concourse_db_passwords.concourse_password}@${module.concourse_rds.rds_address}:${var.concourse_db_port}/${var.concourse_db_name}"
